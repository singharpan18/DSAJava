...
public class StringBasics {
    ...
    public static void main(String[] args) {
        ...
        /*This is a very important Java interview/basic concept. Type	Usage -> String	 length() -> Array	length
        Array: Because array has a property/variable, not method. String: String is a proper Java class. So length is provided through method:
        
        | Situation              | Use    |
        | ---------------------- | ------ |
        | Only reading/comparing | String |
        | Modifying/swapping     | char[] |
        */


        //Input: ArPan Output: aRpAN
